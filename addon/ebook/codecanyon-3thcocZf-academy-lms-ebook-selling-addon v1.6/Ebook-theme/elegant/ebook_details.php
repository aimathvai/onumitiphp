...
<section id="hero_in" class="category-header-area">
    ...
    <div class="row">
        <div class="col-lg-12 order-last order-lg-first radius-10 mt-4 bg-white">
            ...
            <div class="row">
                <div class="col-xl-9">
                    <div class="about-instructor-box mt-5 pb-3 px-4">
                        <div class="about-instructor-title">
                            <h4><?php echo site_phrase('about_instructor'); ?></h4>
                            ...
                            <div class="col-md-3 top-instructor-img w-sm-100">
                                <a href="<?php echo site_url('home/instructor_page/'.$instructor_details['id']); ?>">
                                    <img src="<?php echo $this->user_model->get_user_image_url($instructor_details['id']); ?>"
                                        width="100%" class="rounded-circle instructor-image">
                                </a>
                            </div>
                            <div class="col-md-8 top-instructor-details text-md-start">
                                <h6 class="mb-1 fw-600 v"><a class="text-decoration-none"
                                ...
                                <p class="fw-500 text-14px w-100 ellipsis-line-2 m-0"><?php echo $instructor_details['title']; ?></p>
                                <div class="rating">
                ...
                <div class="col-xl-8">
                    <div class="student-feedback-box mt-3 pb-3 px-4">
                        <div class="student-feedback-title">
                            <h4><?php echo site_phrase('ebook_review'); ?></h4>
                        </div>
                        <div class="row">
                            <div class="col-lg-3">
                            ...
                            <div class="col-xl-9">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <?php $rating_wise_rating_percentage = $this->ebook_model->get_percentage_of_specific_rating($i, 'ebook', $ebook_id); ?>
                                    <div class="row">
